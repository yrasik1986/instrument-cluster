        ...
        Row {
            ...
            Column {
                ...
                Text {
                    ...
                    text: vehicle.canConnected
                          ? vehicle.fuel + "%"
                          : "---"

                    color: vehicle.lowFuel
                           ? "#ff5252"
                           : "white"
            ...
            Column {
                ...
                Text {
                    ...
                    text: vehicle.canConnected
                          ? vehicle.coolantTemperature + "°C"
                          : "---"

                    color: vehicle.highTemperature
                           ? "#ff5252"
                           : "white"
